...
var FilterBlock = &transform.Factory{
	Obj:     nil,
	NewFunc: nil,
}
...
func (b *BlockFilter) Transform(readOnlyBlk *bstream.Block, in transform.Input) (transform.Output, error) {

	preproc := &FilteringPreprocessor{Filter: b}
