...
import (
	...
	_ "github.com/pinax-network/firehose-antelope/types"
...
var StartCmd = &cobra.Command{Use: "start", Short: "Starts Antelope on StreamingFast services all at once", RunE: sfStartE, Args: cobra.ArbitraryArgs}
