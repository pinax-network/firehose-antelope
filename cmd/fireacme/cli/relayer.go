...
func init() {
	...
	launcher.RegisterApp(rootLog, &launcher.AppDef{
		...
		RegisterFlags: func(cmd *cobra.Command) error {
			...
			cmd.Flags().StringSlice("relayer-source", []string{MindreaderGRPCAddr}, "List of live sources (mindreaders) to connect to for live block feeds (repeat flag as needed)")
